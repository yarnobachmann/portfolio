...
return [
    ...
    'generic' => [
        ...
        'actions'                => 'Acties',
        'add'                    => 'Toevoegen',
        'add_folder'             => 'Folder Toevoegen',
        'add_new'                => 'Nieuwe Toevoegen',
        'all_done'               => 'Helemaal Klaar',
        'are_you_sure'           => 'Ben je zeker',
        'are_you_sure_delete'    => 'Ben je zeker dat je wilt verweideren',
        'auto_increment'         => 'Auto Increment',
        'browse'                 => 'Browse',
        'builder'                => 'Builder',
        'bulk_delete'            => 'Bulk delete',
        'bulk_delete_confirm'    => 'Ja, Delete Deze',
        'bulk_delete_nothing'    => 'Je hebt niks geselecteerd om te verweideren',
        'cancel'                 => 'Cancel',
        ...
        'default'                => 'Default',
        'delete'                 => 'Delete',
        'delete_confirm'         => 'Ja, Verweider het!',
        'delete_question'        => 'Weet je zeker dat je dit wilt verweideren',
        'delete_this_confirm'    => 'Ja, Verweider dit',
        'deselect_all'           => 'Deselect Alles',
        'download'               => 'Download',
        'edit'                   => 'Aanpassen',
        'email'                  => 'E-mail',
        'error_deleting'         => 'Sorry er is een probleem met het verweideren',
        'exception'              => 'Exception',
        'featured'               => 'Featured',
        ...
        'items'                  => 'item(s)',
        'keep_sidebar_open'      => 'Yarr! Zak de ankers! (en hou de sidebar open)',
        'key'                    => 'Key',
    ...
    'login' => [
        ...
        'signin_below' => 'Log hier in:',
        'welcome'      => 'Welkom op Yarno\'s admin panel ',
    ],

    'profile' => [
        'avatar'        => 'Avatar',
        'edit'          => 'Verander mijn profiel',
        'edit_user'     => 'Verander Gebruiker',
        'password'      => 'Wachtwoord',
        'password_hint' => 'Leeglaten voor hetzelfde wachtwoord',
        'role'          => 'Role',
        'user_role'     => 'Gebruiker Role',
    ],
